  ...
  public:
    inline void init(LSTM1Params* paramInit, dtype dropout, bool left2right = true) {
        ...
        for (int idx = 0; idx < maxsize; idx++) {
            ...
            _inputgates[idx].setFunctions(&Device::Fsigmoid, &Device::Dsigmoid);
            _forgetgates[idx].setFunctions(&Device::Fsigmoid, &Device::Dsigmoid);
            _outputgates[idx].setFunctions(&Device::Fsigmoid, &Device::Dsigmoid);
            _halfcells[idx].setFunctions(&Device::Ftanh, &Device::Dtanh);
        }
...
class IncLSTM1Builder {
  ...
  public:
    inline void init(LSTM1Params* paramInit, dtype dropout) {
        ...
        _inputgate.setFunctions(&Device::Fsigmoid, &Device::Dsigmoid);
        _forgetgate.setFunctions(&Device::Fsigmoid, &Device::Dsigmoid);
        _outputgate.setFunctions(&Device::Fsigmoid, &Device::Dsigmoid);
        _halfcell.setFunctions(&Device::Ftanh, &Device::Dtanh);
